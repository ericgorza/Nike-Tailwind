    ...
    <section
      ...
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
        <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-2-sm">
            Discover stylish Nike arrivals, quality comfort and innovation for your active life. Make a good use of it!
          </p>
            ...
            {shoes.map((image, index) => (
              <div key={index} className="transition duration-80 hover:scale-110 hover:opacity-95">
                <ShoeCard
                  index={index}
                  imgURL={image}
                  changeBigShoeImage= {(image) => {setBigShoeImg(image)}}
