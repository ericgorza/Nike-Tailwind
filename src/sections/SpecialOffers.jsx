  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className='mt-7 lg:max-w-lg info-text'>Ensuring premium comfort and style, our meticulously crafter footwear is designed to elevate you experience, providing you with unmatched quality, innovation, and a touch of elegance</p>
